    ...
    export default {
        ...
        methods: {
            ...
            initData() {
                ...
                this.allowEdit = 1 == level || 2 == level
            },
            ...
            resetForm() {
                ...
                this.form.areaId = 2
                this.form.name = '碧富美特'
                this.form.address = '成都市双流区航空港'
                this.form.longitude = 0.0
                this.form.latitude = 0.0
                this.form.pos = ''
                this.form.contact = '周传林'
                this.form.contactMobile = '13455555555'
                this.form.envContact = '程道林'
                this.form.envContactMobile = '13888888888'
            },
            openDialog(row) {
                this.resetForm()
            ...
            getList(argc) {
                ...
                argc.areaId = localStorage.getItem('user.areaId')
                enterpriseList(argc)
                    .then(res => {
                        if (res.code === 2000) {
